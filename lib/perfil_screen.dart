...
class _PerfilScreenState extends State<PerfilScreen> {
  ...
  void _saveProfile() {
    UserProvider.instance.updateProfile(
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: dark
                ...
                : [const Color(0xff2d1b69), const Color(0xff4a0e8f)],
          ),
        ),
        child: SafeArea(
          child: LayoutBuilder(
            builder: (context, constraints) {
              // Si la pantalla es muy pequeña, usar columna en lugar de fila
                  ...
                  child: Column(
                    children: [
                            ...
                            Positioned(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  color: const Color(0xffe8c97b).withOpacity(0.9),
                                  boxShadow: [
                                    BoxShadow(
                                      color: const Color(0xffe8c97b).withOpacity(0.4),
                                      blurRadius: 40,
                                      spreadRadius: 10,
                                    )
                                  ],
                      ...
                      Padding(
                        ...
                        child: _buildProfileCard(u),
                      ),
                    ],
                  ),
                );
              }
              // Pantalla ancha: usar fila como estaba
              return Row(
                children: [
...
class _Bird extends StatelessWidget {
  @override
  Widget build(BuildContext context) =>
      CustomPaint(painter: _BirdPainter(), size: const Size(20, 10));
}
...
class _MountainPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    drawMountain([
      ...
      const Offset(.75, .65),
      const Offset(1, .75),
    ], const Color(0xff1e1342));

    final tp = Paint()
      ..color = const Color(0xff0f0a24)
      ..style = PaintingStyle.fill;
    for (int i = 0; i < 12; i++) {
      final x = (i / 12) * size.width + 20;
      final h = 40.0 + (i % 3) * 20;
      final w = 18.0 + (i % 2) * 8;
      canvas.drawPath(
        Path()
          ..moveTo(x, size.height - h)
          ..lineTo(x - w / 2, size.height)
          ..lineTo(x + w / 2, size.height)
          ..close(),
        tp,
      );
    ...
    canvas.drawRect(
      ...
      Paint()
        ..shader = LinearGradient(
          ...
          colors: [
            const Color(0xff3d2a7a).withOpacity(0.3),
            Colors.transparent,
          ],
        ).createShader(
          Rect.fromLTWH(0, size.height * .82, size.width, size.height * .18),
